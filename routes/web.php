...
Route::view('/features/role-based-access', 'public.features.role-access')->name('features.role-access');
Route::view('/features/live-doctor-slot-checks', 'public.features.doctor-slots')->name('features.doctor-slots');
Route::view('/features/24-7-services', 'public.features.services-24-7')->name('features.services-24-7');
Route::view('/features/ambulance-support', 'public.features.ambulance-support')->name('features.ambulance-support');
